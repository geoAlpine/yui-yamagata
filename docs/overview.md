...
**災害ごみ仮置場は、事前に登録できる余地があると考えています。** 発災後に白紙から決まるものではなく、市町村の災害廃棄物処理計画で候補地が選定されているためです。物資配布・炊き出しのみ、発災後に決まる真に動的な情報です。
...
- **物資配布・炊き出しの情報源がありません。** 発災後に決まるため事前登録ができず、現状は住民の報告に依存します
